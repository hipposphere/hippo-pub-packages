...
const _windowsAudioEncoderAssetName =
    'src/generated/windows_audio_encoder_bindings.dart';
const _windowsAudioEncoderLibraryBaseName =
    'speech_utils_windows_audio_encoder';
const _windowsFfmpegRuntimeAssetNamePrefix =
    'src/generated/audio_encoder/windows_ffmpeg_runtime';
const _linuxAudioEncoderAssetName =
    'src/generated/audio_encoder/linux_audio_encoder_bindings.dart';
const _linuxAudioEncoderLibraryBaseName = 'speech_utils_linux_audio_encoder';
const _linuxFfmpegRuntimeAssetNamePrefix =
    'src/generated/audio_encoder/linux_ffmpeg_runtime';
...
const _androidAudioEncoderLibraryBaseName =
    'speech_utils_android_audio_encoder';
const _androidCxxRuntimeAssetName =
    'src/generated/audio_encoder/android_cxx_runtime_bindings.dart';
const _appleAudioEncoderAssetName =
    'src/generated/audio_encoder/apple_audio_encoder_bindings.dart';
const _iosAudioCodecBindingsSource =
...
const _macosAudioCodecBindingsSource =
...
Future<void> buildWindowsAudioEncoderAsset(
  BuildInput input,
  ...
  _copyWindowsRuntimeDllsNextToAudioEncoderLibrary(
    input: input,
    runtimeDlls: runtimeDlls,
  );
  _bundleWindowsFfmpegRuntimeDlls(
    input: input,
    output: output,
    runtimeDlls: runtimeDlls,
  );
...
Future<void> buildLinuxAudioEncoderAsset(
  BuildInput input,
  BuildOutputBuilder output,
) async {
...
void _copyWindowsRuntimeDllsNextToAudioEncoderLibrary({
  ...
  final builtAudioEncoderLibraries = sharedOutputDir
      ...
      .whereType<File>()
      .where(
        (file) => lowercaseFileName(file) == audioEncoderFileName.toLowerCase(),
      )
      .toList(growable: false);
...
void _bundleWindowsFfmpegRuntimeDlls({
  ...
  for (final sourceDll in runtimeDlls) {
    ...
    addBundledDynamicAsset(
      ...
      output: output,
      assetName:
          '$_windowsFfmpegRuntimeAssetNamePrefix/${assetBaseName}_bindings.dart',
...
void _bundleLinuxFfmpegRuntimeLibraries({
  ...
  for (final sourceLibrary in runtimeLibraries) {
    ...
    addBundledDynamicAsset(
      ...
      output: output,
      assetName:
          '$_linuxFfmpegRuntimeAssetNamePrefix/${assetBaseName}_bindings.dart',
      fileUri: bundledLibrary,
    );
  }
}
...
Future<void> buildAndroidAudioEncoderAsset(
  BuildInput input,
  BuildOutputBuilder output,
) async {
...
Future<void> buildIosAudioEncoderAsset(
  BuildInput input,
  BuildOutputBuilder output,
) async {
...
Future<void> buildMacosAudioEncoderAsset(
  BuildInput input,
  BuildOutputBuilder output,
) async {
