#include "../windows/encoding/windows_audio_encoder_transcoder.h"
#include "../windows/encoding/windows_audio_metadata.h"
#include "../windows/encoding/windows_ffmpeg_common.h"

#define SPEECH_UTILS_LINUX_EXPORT __attribute__((visibility("default")))

extern "C" SPEECH_UTILS_LINUX_EXPORT int32_t
speech_utils_linux_encode_audio_file_to_aac(const char* input_path_utf8,
...
extern "C" SPEECH_UTILS_LINUX_EXPORT int32_t
speech_utils_linux_aac_encoder_healthcheck(char* error_utf8, uint32_t error_utf8_capacity) {
  speech_utils::windows_encoding::WriteError("", error_utf8, error_utf8_capacity);
  return speech_utils::windows_encoding::AacEncoderHealthcheck(error_utf8, error_utf8_capacity);
}

extern "C" SPEECH_UTILS_LINUX_EXPORT int32_t
speech_utils_linux_read_audio_metadata(const char* input_path_utf8,
...
extern "C" SPEECH_UTILS_LINUX_EXPORT int32_t
speech_utils_linux_audio_metadata_healthcheck(char* error_utf8, uint32_t error_utf8_capacity) {
  speech_utils::windows_encoding::WriteError("", error_utf8, error_utf8_capacity);
