...
@ffi.DefaultAsset('package:speech_utils/src/encoding/generated/ios_aac_bindings.dart')
library;
...
external int speech_utils_ios_aac_encoder_healthcheck(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
...
>()
external int speech_utils_ios_read_audio_metadata(
  ffi.Pointer<ffi.Char> input_path_utf8,
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Uint32)>()
external int speech_utils_ios_audio_metadata_healthcheck(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
