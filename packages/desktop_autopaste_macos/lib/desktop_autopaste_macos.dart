...
import 'src/generated/desktop_autopaste_macos_bindings.dart' as bindings;
import 'src/generated/desktop_autopaste_macos_swiftgen_bindings.dart'
    as swiftgen;

final class DesktopAutopasteMacos extends FfiDesktopAutopastePlatform {
  DesktopAutopasteMacos()
    : super(
  ...
  static void registerWith() {
    DesktopAutopastePlatform.instance = DesktopAutopasteMacos();
  }

  @override
  bool? tryPasteViaPlatformBridge(String text) {
    try {
      return objc.autoReleasePool(() {
        return swiftgen.DesktopAutopasteMacosBridge.pasteIntoCursorViaClipboard(
          text.toNSString(),
        );
      });
    } on Object {
