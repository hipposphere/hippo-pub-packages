...
import 'src/generated/ten_vad_bindings.dart' as ten_vad;
...
final class TenVadFfiBackend extends VadBackend {
  ...
  static TenVadFfiBackend? tryCreate({
    int hopSize = 256,
  ...
  bool isSpeechFrame(
    ...
    _scratchView.setRange(
      0,
      hopSize,
      interleavedPcm16Samples,
      startSampleOffset,
    );
