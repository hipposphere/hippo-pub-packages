...
@ffi.DefaultAsset('package:speech_utils/src/generated/wake_word/sherpa_onnx_bindings.dart')
library;

import 'dart:ffi' as ffi;

@ffi.Native<
  ffi.Pointer<SherpaOnnxKeywordSpotter> Function(ffi.Pointer<SherpaOnnxKeywordSpotterConfig>)
>()
...
external void SherpaOnnxDestroyKeywordSpotter(ffi.Pointer<SherpaOnnxKeywordSpotter> spotter);

@ffi.Native<ffi.Pointer<SherpaOnnxOnlineStream> Function(ffi.Pointer<SherpaOnnxKeywordSpotter>)>()
external ffi.Pointer<SherpaOnnxOnlineStream> SherpaOnnxCreateKeywordStream(
  ffi.Pointer<SherpaOnnxKeywordSpotter> spotter,
);

@ffi.Native<
  ffi.Int32 Function(ffi.Pointer<SherpaOnnxKeywordSpotter>, ffi.Pointer<SherpaOnnxOnlineStream>)
>()
...
@ffi.Native<
  ffi.Void Function(ffi.Pointer<SherpaOnnxKeywordSpotter>, ffi.Pointer<SherpaOnnxOnlineStream>)
>()
...
external void SherpaOnnxFreeKeywordResultJson(ffi.Pointer<ffi.Char> s);
...
external void SherpaOnnxDestroyOnlineStream(ffi.Pointer<SherpaOnnxOnlineStream> stream);
...
final class SherpaOnnxOnlineNemoCtcModelConfig extends ffi.Struct {
  external ffi.Pointer<ffi.Char> model;
}

final class SherpaOnnxOnlineToneCtcModelConfig extends ffi.Struct {
  external ffi.Pointer<ffi.Char> model;
}
...
final class SherpaOnnxOnlineModelConfig extends ffi.Struct {
  ...
  external SherpaOnnxOnlineNemoCtcModelConfig nemo_ctc;

  external SherpaOnnxOnlineToneCtcModelConfig t_one_ctc;
}
