...
class EnvManager {
  ...
  static Future<void> loadEnvFromUrl(String url) async {
  ...
  static Future<void> loadEnvFromFile(String filePath) async {
    ...
    _envVars.addAll(EnvParser().parse(contents.split('\n')));
  }

  static Future<void> loadEnvFromAsset(String assetPath) async {
...
class EnvParser {
  ...
  Map<String, String> parseOne(String line, {Map<String, String> envMap = const {}}) {
