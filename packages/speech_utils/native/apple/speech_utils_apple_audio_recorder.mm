...
#include "recorder/speech_utils_apple_audio_recorder_api.h"
...
SPEECH_UTILS_RECORDER_SYMBOL(list_input_devices_json)(char* out_json_utf8,
                                                     ...
                                                     char* error_utf8,
                                                     uint32_t error_utf8_capacity) {
  return speech_utils::apple_recorder::ListInputDevicesJson(out_json_utf8, out_json_capacity, error_utf8,
                                                           error_utf8_capacity);
}
...
SPEECH_UTILS_RECORDER_SYMBOL(start_file)(const char* output_path_utf8, uint32_t sample_rate_hz,
                                         ...
                                         char* error_utf8,
                                         uint32_t error_utf8_capacity) {
  return speech_utils::apple_recorder::StartFile(output_path_utf8, sample_rate_hz, channel_count,
...
SPEECH_UTILS_RECORDER_SYMBOL(start_stream)(uint32_t sample_rate_hz, uint32_t channel_count,
                                           ...
                                           char* error_utf8,
                                           uint32_t error_utf8_capacity) {
  return speech_utils::apple_recorder::StartStream(sample_rate_hz, channel_count, frames_per_chunk,
                                                  input_device_id_utf8, error_utf8,
                                                  error_utf8_capacity);
}
...
SPEECH_UTILS_RECORDER_SYMBOL(is_recording)(int32_t* out_is_recording, char* error_utf8,
                                           uint32_t error_utf8_capacity) {
  return speech_utils::apple_recorder::IsRecording(out_is_recording, error_utf8, error_utf8_capacity);
}
