...
enum FloatingBottomSheetPosition { bottomLeftDialog, bottomRightDialog }

class FloatingBottomSheetType extends WoltModalType {
  final EdgeInsetsDirectional padding;
  final FloatingBottomSheetPosition position;
  ...
  Offset positionModal(Size availableSize, Size modalContentSize, TextDirection textDirection) {
    if (position == FloatingBottomSheetPosition.bottomLeftDialog) {
      return Offset(padding.start, availableSize.height - modalContentSize.height - padding.bottom);
    }
    return Offset(
  ...
  Widget buildTransitions(
    ...
    final slideAnimation = Tween<Offset>(
      begin: position == FloatingBottomSheetPosition.bottomLeftDialog
