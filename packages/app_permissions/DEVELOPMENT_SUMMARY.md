...
Created a standalone Flutter plugin package `app_permissions` for checking and requesting desktop permissions (Accessibility and Input Monitoring) on macOS and Windows.
...
app_permissions/
├── lib/
│   ├── app_permissions.dart                    # Main API
│   ├── app_permissions_method_channel.dart     # Method channel implementation
│   ├── app_permissions_platform_interface.dart # Platform interface
│   └── src/
│       └── permission_status.dart                  # PermissionStatus enum
├── macos/
│   └── app_permissions/
│       └── Sources/app_permissions/
│           └── AppPermissionsPlugin.swift      # macOS implementation
├── windows/
│   └── app_permissions_plugin.cpp              # Windows implementation
├── example/                                        # Example app
