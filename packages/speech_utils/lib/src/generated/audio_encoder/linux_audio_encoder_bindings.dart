...
@ffi.DefaultAsset(
  'package:speech_utils/src/generated/audio_encoder/linux_audio_encoder_bindings.dart',
)
library;
...
>()
external int speech_utils_linux_encode_audio_file_to_aac(
...
external int speech_utils_linux_aac_encoder_healthcheck(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
...
>()
external int speech_utils_linux_read_audio_metadata(
  ffi.Pointer<ffi.Char> input_path_utf8,
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Uint32)>()
external int speech_utils_linux_audio_metadata_healthcheck(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
