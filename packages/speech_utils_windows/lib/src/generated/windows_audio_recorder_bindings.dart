...
@ffi.DefaultAsset(
  'package:speech_utils_windows/src/generated/windows_audio_recorder_bindings.dart',
)
library;
...
>()
external int speech_utils_windows_audio_recorder_set_continous_capture(
  int enabled,
  ffi.Pointer<ffi.Void> start_config,
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Uint32)>()
external int speech_utils_windows_audio_recorder_reset(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
