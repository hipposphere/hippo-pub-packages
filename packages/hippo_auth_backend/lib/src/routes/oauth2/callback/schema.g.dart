...
final class _$OAuth2CallbackParams implements JsonEncodable {
  const _$OAuth2CallbackParams({required this.providerId});

  static const schemaId = "OAuth2CallbackParams";
  ...
  static OAuth2CallbackParams fromJson(Object? value) {
    final json = value! as Map<String, Object?>;
    return OAuth2CallbackParams(providerId: json["providerId"]! as String);
  }
}
