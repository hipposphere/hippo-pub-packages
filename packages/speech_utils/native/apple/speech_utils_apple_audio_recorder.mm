...
extern "C" __attribute__((visibility("default"))) int32_t
SPEECH_UTILS_RECORDER_SYMBOL(start_file)(
...
extern "C" __attribute__((visibility("default"))) int32_t
SPEECH_UTILS_RECORDER_SYMBOL(start_stream)(
    const speech_utils::recorder::RecorderStartConfig* start_config,
    char* error_utf8,
    uint32_t error_utf8_capacity) {
  return speech_utils::apple_recorder::StartStream(start_config, error_utf8, error_utf8_capacity);
}
...
extern "C" __attribute__((visibility("default"))) int32_t
SPEECH_UTILS_RECORDER_SYMBOL(reset)(char* error_utf8, uint32_t error_utf8_capacity) {
