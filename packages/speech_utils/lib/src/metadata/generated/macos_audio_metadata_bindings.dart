...
@ffi.DefaultAsset('package:speech_utils/src/metadata/generated/macos_audio_metadata_bindings.dart')
library;
...
>()
external int speech_utils_macos_read_audio_metadata(
...
external int speech_utils_macos_audio_metadata_healthcheck(
  ffi.Pointer<ffi.Char> error_utf8,
  int error_utf8_capacity,
);
